...
RsgSeparator(p='VFrame_3')
RsgHorizontalFrame(name='HFrame_12', p='VFrame_3', layout='0', pl=11, pr=0, pt=0, pb=0)
...
RsgCheckButton(p='VFrame_10', text='Surface Topography', keyword='boolSurfTop', default=True)
RsgCheckButton(p='VFrame_10', text='Contact Forces', keyword='boolContVect', default=True)
...
RsgCheckButton(p='VFrame_10', text='Stress Invariants (centerline and surface)', keyword='boolInvStress', default=True)
RsgCheckButton(p='VFrame_10', text='Densification: RD,DENSITY,PEQC4 (centerline and surface)', keyword='boolDensity', default=True)
RsgSeparator(p='VFrame_10')
